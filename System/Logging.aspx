...
<head runat="server">
    ...
    <script>
      ...
      mapOptions);
            ...
            var markerTrinco = new google.maps.Marker({
                position: new google.maps.LatLng(8.545992, 81.223378),
                map: map,
            ...
            var markerGall = new google.maps.Marker({
                position: new google.maps.LatLng(6.033653, 80.229908),
                map: map,
                title: 'Galle Harbour'
            }
            ...
            var markerkks = new google.maps.Marker({
                position: new google.maps.LatLng(9.816132, 80.031297),
                map: map,
                title: 'KKS'
            }
            ...
            var markeroulu = new google.maps.Marker({
                position: new google.maps.LatLng(9.5286281, 79.7154343),
                map: map,
                title: 'Delft Jetty'
            }
            ...
            google.maps.event.addListener(marker, 'click', function () {
                ...
                document.getElementById('<%= pnlInfo.ClientID %>').innerHTML = '<object width="100%" height="100%" type="text/aspx" data="online.aspx?Loc=1002"></object>';
            });


            google.maps.event.addListener(markerTrinco, 'click', function () {
                (document.getElementById('<%=txtloc.ClientID%>')).value = 1;
            ...
            google.maps.event.addListener(markerGall, 'click', function () {
                (document.getElementById('<%=txtloc.ClientID%>')).value = 1;
            ...
            google.maps.event.addListener(markerkks, 'click', function () {
                (document.getElementById('<%=txtloc.ClientID%>')).value = 1;
            ...
            google.maps.event.addListener(markeroulu, 'click', function () {
                (document.getElementById('<%=txtloc.ClientID%>')).value = 1;

                document.getElementById('<%= pnlInfo.ClientID %>').style.visibility = 'visible';
                document.getElementById('<%= pnlInfo.ClientID %>').innerHTML = '<object width="100%" height="100%" type="text/aspx" data="online.aspx?Loc=1006"></object>';
            });
